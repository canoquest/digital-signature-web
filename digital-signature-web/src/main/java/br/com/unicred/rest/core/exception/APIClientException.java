 ...
 * @author carlos.costa
 */
public class APIClientException extends Exception implements Serializable {
	 ...
	 */
	public APIClientException(final String message, final Throwable cause, final boolean enableSuppression,
