...
public class APIClientFacade2 {
	
	private static final Logger LOGGER = Logger.getLogger(APIClientFacade2.class);
	...
	public APIClientFacade2(String host, String path, String contentType) {
		super();
		this.host = host;
		this.path = path;
	...
	public Object get(Map<String, Object> queryParameters, Class<?> classe) throws APIClientException {		
		APIClientBuilder apiClientBuilder = new APIClientBuilder(host, path, contentType, queryParameters);		
	...
	public Object post(Object objectRequest, Map<String, Object> queryParameters, Class<?> classe) throws APIClientException {		
